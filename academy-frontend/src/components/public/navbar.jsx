...
const NavLink = ({ href, children }) => {
  ...
  return (
    ...
    <Link
      href={href}
      className="
        relative text-sm font-semibold tracking-[0.02em]
            ...
            <div className="relative z-10 flex items-center justify-between w-full h-20">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] uppercase tracking-[0.25em] text-slate-400 dark:text-slate-500">
              ...
              <div className="hidden lg:flex items-center gap-4">
                ...
                <Link
                  ...
                  className="
                    ...
                    hover:shadow-[0_0_45px_rgba(79,70,229,0.45)]
